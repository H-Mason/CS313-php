...
<body>
    ...
    <div><form action="addAnimalConf.php" method="post"> 
        ...
        Animal Description: <input type="textarea" rows="10" cols="50"  name="description"><br><br>
        Picture:
        Diet: 
        <?php
        ...
        <?php
            ...
            print("</select><br><br>");
        ?>
        Size Description: <input type="textarea" class="inputDesc" name="description"><br><br>
        Region Picture:
